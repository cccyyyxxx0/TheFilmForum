				...
				<div>
				  ...
				  <input id="mobile_menu" type="checkbox">
					<ul class="nav">
						...
						<ul>
						  <li><a href="cinema.html">电影院</a></li>
						  <li><a href="magazine.html">杂志</a></li>
						</ul>
						</li>  
						<li><a href="archives.html" class="color5">条件查找</a></li>
						<li><a href="contact.html" class="color6">联系我们</a></li>
						<div class="clearfix"></div>
					</ul>
				</div>			
			</div>
			...
			<script>
				$(document).ready(function() {
					$("#owl-demo").owlCarousel({
						items : 3,  //幻灯片每页可见个数
                        lazyLoad : true,  //	延迟加载
                        autoPlay : 2000,   //默认 5 秒切换一次
                        pagination : true,  //显示分页
                        navigation : true,  //显示“上一个”、“下一个”
                        navigationText :  true,  //设置“上一个”、“下一个”文字，默认是[“prev”,”next”]
					});
				});
			</script>
		<!-- //requried-jsfiles-for owl -->
...
<div class="content">
	<div class="col-md-8 content-top">
		<div class="number">
			...
			<h3><a href="single.html">Lorem Ipsum只是印刷的虚拟文本 </a></h3>
			<p>Lorem Ipsum只是印刷和排版行业的虚拟文本。Lorem Ipsum自15世纪以来一直是行业标准的虚拟文本，当时一个不知名的印刷工拿走了一个字型的厨房，然后把它拼凑成一本活字样书 它不仅延续了五个世纪，而且还经历了电子排版的飞跃，基本保持不变。它在20世纪60年代随着Letraset的发行而流行起来 包含</p>
			<!---->		
    		<div class="span_8">
    		  <div class="row_8">
    		    <div class="sap_tabs">	
			...
			<div class="movie">
				<ul class="comment">
					<li><span>类别 : <a href="single.html"> Movie</a> </span></li>
					<li><a href="#"><i> </i>5 评论  </a></li>
				</ul>				
				<a href="single.html" class="more"> 更多观看 </a>
			<div class="clearfix"> </div>
			</div>
		</div>
			<!---->
			...
			<div class="movie">
				<ul class="comment">
					<li><span>类别 : <a href="single.html">Fashion </a></span></li>
					<li><a href="#"><i> </i>5 评论  </a></li>
				</ul>				
				<a href="single.html" class="more">更多阅读 </a>
			<div class="clearfix"> </div>
			</div>
		</div>
			<!---->
			<div class="older-top">
				<a href="#" class="older"><i> </i>旧贴子</a>
				<a href="#" class="older top-old"><i > </i>新帖子</a>
				<div class="clearfix"> </div>
			</div>
			<!---->
	</div>
	<!---->
		<div class="col-md-4 content-bottom">
			<div class="story"><h4  class="stories"><span>热门系列</span></h4></div>
			<!---->
			<div class="cd-tabs">
			<nav>
				<ul class="cd-tabs-navigation">
					<li><a data-content="fashion"  href="#0">时尚 <i> </i></a></li>
					<li><a data-content="cinema" href="#0" class="selected fashion1">电影<i> </i></a></li>
					<li><a data-content="television" href="#0" class="fashion2">电视<i> </i></a></li>
